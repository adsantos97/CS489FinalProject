...
public class CoreActivity extends Activity {
    ...
    private void updateExerciseImage(ImageView v) {
        ...
        switch (exerciseDie.getValue()) {
            case 1:
                v.setImageResource(R.drawable.core1);
                break;
            case 2:
                v.setImageResource(R.drawable.core2);
                break;
            case 3:
                v.setImageResource(R.drawable.core3);
                break;
            case 4:
                v.setImageResource(R.drawable.core4);
                break;
            case 5:
                v.setImageResource(R.drawable.core5);
                break;
            case 6:
                v.setImageResource(R.drawable.core6);
                break;
        }
    }
